...
```text
+--------------------------------------------------------------------------------+
|                 VOICE-BASED AI ASSISTANT SYSTEM ARCHITECTURE                  |
+--------------------------------------------------------------------------------+

+----------------------+        +---------------------------------------------+
|   USER / FRONTEND    |        |     BACKEND – LOCAL API (FASTAPI)          |
+----------------------+        +---------------------------------------------+
| • React Interface    | -----> | • /stt                                     |
| • Voice Recording    | Audio  | • /llm                                     |
| • Transcript Display | Input  | • /execute                                 |
| • AI Response        |        | • /rag_query                               |
| • Audio Playback     |        | • /tts                                     |
+----------------------+        +---------------------------------------------+
                                              |
                                              v
                     ...
                     |--------------------------------------|
                     | Keyword-Based Command / Query Split  |
                     +--------------------------------------+
                               |                     |
                      Command  |                     | Query
                               v                     v
           ...
           | • Browser Automation        |   | • FAISS Vector DB           |
...
|                                SECURITY LAYER                                  |
+--------------------------------------------------------------------------------+
| AES Audio Encryption | Transcript Encryption | Secure API Communication        |
+--------------------------------------------------------------------------------+

+--------------------------------------------------------------------------------+
|                                  DATA STORAGE                                  |
+--------------------------------------------------------------------------------+
| Encrypted Audio | Encrypted Transcripts | Conversation History                 |
+--------------------------------------------------------------------------------+
